...
const ContactUsPage = () => {
  ...
  return (
    <div className="min-h-screen  text-white flex flex-col items-center justify-center pt-[7rem] px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <input
                  ...
                  className="p-3 rounded-xl bg-[#1c2130] border border-[#2a2f42] w-full"
                />
                {errors.fullName && (
